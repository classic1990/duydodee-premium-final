import { db, doc, getDoc, collection, collectionGroup, getDocs, writeBatch, SCHEMA, serverTimestamp, query, orderBy, where, limit, deleteDoc, logActivity } from '/js/services/firebase.js';
